  ...
  <div class="wrapper">
    <el-form ref="form" :model="form" :rules="formRules" style="width: 460px;" label-width="100px" v-loading="formDataLoading">
      ...
      <el-form-item label="路径" prop="path">
        <self-dict-select v-model="form.path" type="area_type"></self-dict-select>
      </el-form-item>
      <el-form-item label="父级" prop="parentId">
        <ChannelInputSelect ref="channelinput"  v-model="form.parentId">
        </ChannelInputSelect>
      </el-form-item>
...
<script>
  ...
  export default {
    name: 'ChannelEdit',
    components: {ChannelInputSelect, SelfDictSelect, SiteSelect},
    data () {
      return {
        // 编辑的id
        id: null,
